...
fun RegistrationScreen() {
    ...
    val registrationScreenController = koinInject<RegistrationScreenController>()
    ...
    Column(
        ...
        Column(
            ...
            Text(
                text = "Get your Spotride account",
            ...
            Button(
                onClick = {
                    coroutineScope.launch {
                        controller.doRegisterUser(inputEmail, inputPassword)
                    }
                },
                modifier = Modifier
                    .fillMaxWidth()
            ...
            Row {
                ...
                Text(
                    ...
                    modifier = Modifier.clickable { /* TODO: login */ }
                )
            }
        }
